...
低搜索量、低成交量本身**不是淘汰理由**。无人做的冷门细分往往正是"先入场"机会：竞争弱、头部未垄断、评论壁垒低，小卖家更容易卡位。鹰眼在 Level-1 预筛时，**不要仅因搜索量/成交量小就 EARLY_REJECT**。冷门方向应区分两种情况：

- **真死方向**（淘汰）：需求几乎为零且无可见趋势、品类本身在萎缩、或触犯红线（合规/重货/侵权/利润倒挂）。
- **冷门机会**（保留深挖）：需求虽小但稳定或上升、需供比好（商品数少于搜索量）、有清晰可观察的痛点或场景、头部不集中。这类应进入 Level-2 深挖，而不是因"太小众"被砍。

判断"小而美"机会时，优先看：需供比、增长趋势（含往年同期）、头部集中度、评论痛点清晰度——而不是绝对搜索量。把"先入场红利"作为机会信号纳入考量。
